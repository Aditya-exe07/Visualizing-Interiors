...
struct kitchenstoolview : View {
    var body: some View {
        ARViewContainer7().edgesIgnoringSafeArea(.all)
    }
}
...
struct ARViewContainer7: UIViewRepresentable {
    class Coordinator: NSObject, UIGestureRecognizerDelegate {
        ...
        func loadModel() {
            cancellable = ModelEntity.loadModelAsync(named: "kitchen_stool")
